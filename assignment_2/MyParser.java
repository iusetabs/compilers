                ...
                public static void main (String [] args) throws ParseException, FileNotFoundException {
                        ...
                        if ( args.length < 1){
                                ...
                                try{
                                        ...
                                        System.out.println("\u005cnSYMBOL_TABLE");
...
*/
 ...
 /*@bgen(jjtree) Prog_Start */
  ...
  static final public void parameter_list(String function_name) throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case ID:
  ...
  static final public void nemp_parameter_list(String function_name) throws ParseException {
  ...
  static final public void statement() throws ParseException {
    ...
    case IF:
      jj_consume_token(IF);
                 ASTIF_CONDITION jjtn003 = new ASTIF_CONDITION(JJTIF_CONDITION);
                 boolean jjtc003 = true;
                 jjtree.openNodeScope(jjtn003);
      try {
        condition();
      ...
      jj_consume_token(BEGIN);
                ...
                ifID++;
          ASTIF_CODE jjtn004 = new ASTIF_CODE(JJTIF_CODE);
          boolean jjtc004 = true;
          jjtree.openNodeScope(jjtn004);
      try {
        statement_block();
